# Minimal OpenROAD PNR + STA flow for dma_engine on sky130_fd_sc_hd.
...
set NETLIST  /home/user/LLM_accelerator/rtl/asic/build/synth_blocks/dma_engine.synth_sky.v
set TOP      dma_engine
...
# --- Constraints ---
create_clock -period 6.21 -name clk [get_ports clk]
