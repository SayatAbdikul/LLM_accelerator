# Minimal OpenROAD PNR + STA flow for sfu_engine on sky130_fd_sc_hd.
...
set NETLIST  /home/user/LLM_accelerator/rtl/asic/build/synth_blocks/sfu_engine.synth_sky.v
set TOP      sfu_engine
...
initialize_floorplan -utilization 30 -aspect_ratio 1.0 -core_space 8.0 -site unithd
...
# --- Report STA ---
puts "===== POST-PNR STA (placement-aware (Phase-6 SM_OUT_NORM, abc -fast)) ====="
report_clock_min_period
puts "\n===== worst path ====="
report_checks -path_delay max -endpoint_count 5 -unconstrained
puts "\n===== summary ====="
report_wns
report_tns
report_design_area
