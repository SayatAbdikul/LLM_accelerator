...
// ===========================================================================
// gen-2 FP32 ops (frozen ISA) — byte-exact vs the golden fixtures under
// rtl/verilator/fixtures/gen2/ (generated by software/tools/
// gen_gen2_fixtures.py from the pinned golden simulator). Anti-drift:
// the reference IS the golden model, so eps/rounding/gelu-form drift
// cannot pass. Fixture shape: M=16, N=64, FP16 storage; offsets in
// 16-byte units src1=0, src2=512, dst=1024.
// ===========================================================================
