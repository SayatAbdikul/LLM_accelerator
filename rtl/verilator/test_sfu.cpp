...
// 2026-05-23 Phase B/C: recovered from the deleted gen-1 block (originally
// defined before the gen-2 tests). Geometry constants shared by all the
// gen-2 fixture tests below — M=16 rows, N=64 cols, ABUF unit offsets.
...
// Recovered with the G2_* constants above; used by every test_g2_* test
// below. (2026-05-23 Phase B/C carryover from the deleted gen-1 block.)
