...
> **Historical revision stub, reconciled 2026-09-03.** Its accepted content was
> folded into [`isa_generation_freeze.md`](isa_generation_freeze.md). Keep this
> file only as measurement provenance; it is not normative and its pinned-blob
> discussion reflects the repository at proposal time. The current executable
> contract is [`isa_spec.md`](isa_spec.md).
