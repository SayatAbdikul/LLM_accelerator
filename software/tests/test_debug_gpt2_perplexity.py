...
def test_debug_gpt2_perplexity_outputs_json_sections():
    ...
    assert data["ptq_preset"] == "output_aware_mlp_lm_head_0_1_4_8_to_11"
...
def test_debug_gpt2_perplexity_preset_sweep_json_sections():
    ...
    data = json.loads(proc.stdout)
    assert data["preset_sweep"]["promoted_default"] == "output_aware_mlp_lm_head_0_1_4_8_to_11"
    ...
    assert data["preset_sweep"]["default_replacement_candidate"]["baseline"] == "output_aware_mlp_lm_head_0_1_4_8_to_11"
