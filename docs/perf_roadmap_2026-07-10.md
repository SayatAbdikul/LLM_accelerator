...
> **Superseded historical roadmap, reconciled 2026-09-03.** This remains a
> record of levers A/C/B/D/E, but its measurements predate the Port-A fix and
> later scheduling/pipeline work. The 2026-07-16 document superseded it and is
> itself now a dated campaign record. Absolute token rates use the historical
> 34.41 MHz partial-design peg. See [current project status](project_status.md)
> for latest cycles and timing limitations, and [the index](README.md) for
> document authority.
