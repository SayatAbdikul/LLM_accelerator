...
> **Historical debug plan, reconciled 2026-09-03.** The divergence described
> below was fixed. Several named tests and counts have since changed, and the
> retired gen-1 SFU paths were removed. Use the current
> [RTL testbench guide](../rtl/TESTBENCHES.md),
> [project status](project_status.md), and [documentation index](README.md).
